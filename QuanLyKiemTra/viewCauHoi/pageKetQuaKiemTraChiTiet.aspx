<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="pageKetQuaKiemTraChiTiet.aspx.cs" Inherits="QuanLyKiemTra.viewCauHoi.pageKetQuaKiemTraChiTiet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h4>Chi Tiết Kết Quả Bài Kiểm Tra</h4>
        <asp:HyperLink ID="hlQuayLai" runat="server" CssClass="btn btn-secondary btn-sm mb-3" Text="Quay lại danh sách" />
